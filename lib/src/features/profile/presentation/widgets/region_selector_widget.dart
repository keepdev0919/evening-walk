...
class _RegionSelectorWidgetState extends State<RegionSelectorWidget> {
  ...
  // 한국 행정구역 데이터
  static const Map<String, List<String>> _koreanRegions = {
    '서울특별시': [
      '강남구',
      '강동구',
      '강북구',
  ...
  void _onDistrictSelected(String? district) {
    ...
    if (_selectedProvince != null && district != null) {
      // 최종 지역 정보 전달
      final fullRegion = '$_selectedProvince $district';
        ...
        Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              items: _koreanRegions.keys.map((String province) {
